...
G2 = generator2(32)
#D = discriminator(16)
G1.load_state_dict(torch.load("/content/gdrive/MyDrive/SiruiW/MNIST_generator1_param.pkl"))
G2.load_state_dict(torch.load("/content/gdrive/MyDrive/SiruiW/MNIST_generator2_param.pkl"))
