...
train_loader = torch.utils.data.DataLoader(
    datasets.EMNIST('EMNIST/raw/t10k-images-idx3-ubyte', train=False, download=True, transform=transform, split='letters'),
...
G2 = generator2(32)
#D = discriminator(16)
G1.load_state_dict(torch.load("/content/gdrive/MyDrive/SiruiW/results_EMNIST/EMNIST_generator1_param.pkl"))
G2.load_state_dict(torch.load("/content/gdrive/MyDrive/SiruiW/results_EMNIST/EMNIST_generator2_param.pkl"))
